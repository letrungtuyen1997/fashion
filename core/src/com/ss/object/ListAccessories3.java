...
public class ListAccessories3 {
    ...
    public ListAccessories3(TextureAtlas atlas, Group group, GamePlay gamePlay){
        this.group = group;
    ...
    private void loadListItem(){
        ...
        groupItem.setWidth(2300);
        groupItem.setHeight(300);
        groupItem.setOrigin(Align.center);
        for (int i=0;i<10;i++){
            item = GUI.createImage(atlas,"hand"+(i+1));
            ...
            item.setPosition(70+(paddingX)*i,20);
        ...
        for (int i =0 ;i<arrItem.size;i++){
            ...
            arrItem.get(i).addListener(new ClickListener(){
                ...
                public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                    ...
                    gamePlay.showAccessories3(finalI);
