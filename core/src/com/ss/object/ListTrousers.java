...
public class ListTrousers {
    ...
    public ListTrousers(TextureAtlas atlas, Group group, GamePlay gamePlay,TextureAtlas uiAtlas,BitmapFont font){
        this.font = font;
        this.group = group;
        ...
        this.atlas = atlas;
        if(GMain.Pref.getInteger("check6")==0){
            setArrLock();
            GMain.Pref.putInteger("check6",1);
            GMain.Pref.flush();
        }else {
           // System.out.println("check:"+GMain.Pref.getString("quan"));
            String str = GMain.Pref.getString("quan").replace("[","");
            str = str.replace("]","");
            str2  =str.split(",");
        }
        loadListItem();
    ...
    private void setArrLock(){
        ...
        GMain.Pref.putString("quan",arrSet.toString());
        GMain.Pref.flush();
       // System.out.println("check:"+GMain.Pref.getString("quan"));
        String str = GMain.Pref.getString("quan").replace("[","");
        str = str.replace("]","");
    ...
    private void loadListItem(){
        ...
        for (int i=0;i<10;i++){
            item = GUI.createImage(atlas,"quan"+(i+1));
            ...
            item.setPosition(50+(paddingX*0.6f)*i,-130);
    ...
    private void Unlock(int index){
        ...
        GMain.Pref.putString("quan",arrStr.toString());
        GMain.Pref.flush();
