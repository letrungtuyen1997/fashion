...
public class ListHair {
    ...
    private boolean isDrag = false;
        ...
        public ListHair(TextureAtlas atlas, Group group, GamePlay gamePlay,TextureAtlas uiAtlas,BitmapFont font){
            ...
            if(GMain.Pref.getInteger("check1")==0){
                setArrLock();
...
//            showListHair();
        ...
        private void loadListItem(){
            ...
            groupItem.setWidth(2700);
            groupItem.setHeight(300);
            groupItem.setOrigin(Align.center);
            for (int i=0;i<11;i++){
                item = GUI.createImage(atlas,"toc"+(i+1));
                ...
                item.setPosition(50+(paddingX*0.6f)*i,0);
                groupItem.addActor(item);
                Image Lock = GUI.createImage(atlas,"lock");
    ...
    private void setTouch(int index){
        ...
        private void Unlock(int index){
            ...
            GMain.Pref.putString("hair",arrStr.toString());
            GMain.Pref.flush();
