...
public class ListShoes {
    ...
    public ListShoes(TextureAtlas atlas, Group group, GamePlay gamePlay,TextureAtlas uiAtlas,BitmapFont font){
        this.font = font;
        this.group = group;
        ...
        this.atlas = atlas;
        if(GMain.Pref.getInteger("check5")==0){
            setArrLock();
            GMain.Pref.putInteger("check5",1);
            GMain.Pref.flush();
        }else {
            System.out.println("check:"+GMain.Pref.getString("shoes"));
            String str = GMain.Pref.getString("shoes").replace("[","");
            str = str.replace("]","");
            str2  =str.split(",");
        }
        loadListItem();
    ...
    private void setArrLock(){
        ...
        GMain.Pref.putString("shoes",arrSet.toString());
        GMain.Pref.flush();
        System.out.println("check:"+GMain.Pref.getString("shoes"));
        String str = GMain.Pref.getString("shoes").replace("[","");
        str = str.replace("]","");
    ...
    private void loadListItem(){
        ...
        for (int i=0;i<10;i++){
            ...
            Lock.setPosition(230+paddingX*i,100);
...
//                            group.remove();
    ...
    private void Unlock(int index){
        ...
        GMain.Pref.putString("shoes",arrStr.toString());
        GMain.Pref.flush();
